...
TString datafile = "/lustre/cmswork/abragagn/BPH/BsAnaV13_2/src/PDAnalysis/Ntu/bin/ntuples/fittree_ntuBuData2018A.root";
...
double ctau_PDG     = 0.04911; // from PDG 2019
double ctau_PDG_err = 0.00012;
double ctau_mc      = 0.050095320;
...
void ct2Dfit_Bp()
{
    ...
    auto modelEFF = new TF1("modelEFF","expo(0)*ROOT::Math::Chebyshev4(x,[2],[3],[4],[5],[6])",0.007,0.5);
    ...
    // Input variables
    auto svmass= new RooRealVar("svmass", "M_{B^{0}} [GeV/c^{2}]",5.15,5.4);
    ...
    // Sidebands
    // svmass->setRange("sbL",5.0,5.15);
    // svmass->setRange("sbR",5.4,5.4);
    ...
    auto ctau = new RooRealVar("ctau", "ctau",  ctau_PDG, 0.045, 0.055);
    ...
    // RooFitResult* ctBkg_Prefit = ctBkgPdf->fitTo(*data,Save(),NumCPU(8),Range("sbR"));
    ...
    cout<<"PDG ctau: "<<ctau_PDG*1e+04<<endl;
