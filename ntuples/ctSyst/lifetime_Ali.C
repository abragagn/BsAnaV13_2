...
TString bdfile = "/lustre/cmswork/abragagn/BPH/BsAnaV13_2/src/PDAnalysis/Ntu/bin/ntuples/fittree_ntuBdMC2017.root";
TString bufile = "/lustre/cmswork/abragagn/BPH/BsAnaV13_2/src/PDAnalysis/Ntu/bin/ntuples/fittree_ntuBuMC2017.root";
...
void lifetime_Ali()
{
    ...
    TRandom3 *decay = new TRandom3(567);
    ...
    {
        Double_t ctaugen1 =  decay->Exp(ctau_mc);
    ...
    RooRealVar *BsCt2DMC = new RooRealVar("BsCt2DMC","ct [cm]",0.007,0.4);
    ...
    RooRealVar *ctau = new RooRealVar("ctau", "ctau",  ctau_mc, 0.04, 0.06);
    ...
    RooGaussModel *gm_sig = new RooGaussModel("gm_sig","gauss model scaled bt per-event error", *BsCt2DMC, *bias, *sdscale, *BsCt2DMCErr);
    RooDecay *decay_gm = new RooDecay("decay_gm","decay",*BsCt2DMC, *ctau, *gm_sig, RooDecay::SingleSided);
    ...
    RooFitResult* fitRes = MTpdf->fitTo(*data,Save(),NumCPU(8));
    fitRes->Print("v");
